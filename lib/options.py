...
def args_parser():
    ...
    parser.add_argument('--rounds', type=int, default=110,
                        help="number of rounds of training")
    parser.add_argument('--all_num_users', type=int, default=20,
    ...
    # Local arguments
    parser.add_argument('--ways', type=int, default=3, help="num of classes (n 所有客户端的平均类别数)")
    parser.add_argument('--shots', type=int, default=100, help="num of shots (k 所有客户端的平均训练数据数)")
